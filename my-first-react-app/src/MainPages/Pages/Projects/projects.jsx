...
function Project(){
    const highlights = [
        ...
        {img:module, title:"Module Enrolment System", desc:"This is my first large scale project in java, allowing a student to enrol on a class of his choosing. For more information click ",
            link:"#module", index:2
        },
    ]
    const websites = [

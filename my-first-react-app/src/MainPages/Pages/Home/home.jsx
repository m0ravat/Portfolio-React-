...
function Home() {
  const Slides = [
    { img: code, text: (
      <div className='text-standard  bg-white dark:bg-gray-800 p-1'>
        <h1 className='border-2 border-b-black border-r-0 border-l-0 border-t-0 mb-2 text-large dark:border-b-white '>Welcome to my Website!</h1>
        ...
        <a href="https://vercel.com/m0ravats-projects" target='_blank' rel="noopener noreferrer" className='pl-2 text-rose-950 dark:text-rose-400'> • Vercel (My Websites)</a> <br />
        <a href="https://github.com/m0ravat" target="_blank" rel="noopener noreferrer" className='pl-2 text-rose-950 dark:text-rose-400'> • My GitHub</a> <br />
        <a href="https://www.linkedin.com/in/muhammad-ravat" target='_blank' rel='noopener noreferrer' className='pl-2 text-rose-950 dark:text-rose-400'> • LinkedIn</a>
      </div>
    ), index: 0 },
    
    { img: code, text: (
      <div className='text-standard bg-white dark:bg-gray-800 p-1'>
        <h1 className='border-2 border-b-black border-r-0 border-l-0 border-t-0 mb-2 text-large dark:border-b-white '>About Me</h1>
